...
export default function CFiles({ currentUser }) {
...
body: JSON.stringify({
            ...record,
            ...(editingRecord ? { created_by: auditUserLabel, modified_by: auditUserLabel } : { modified_by: auditUserLabel }),
          }),
        });
  ...
  return (
    <div style={{ padding: 24, fontFamily: "'Inter', sans-serif", background: theme.bg, minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, flexWrap: 'wrap', gap: 10 }}>
        <div>
          <h2 style={{ fontSize: 19, fontWeight: 600, margin: 0, color: theme.text }}>C-Files Management</h2>
      ...
      {stats.pending > 0 && (
        <div style={{ background: theme.card, borderRadius: 14, border: `1px solid ${theme.border}`, borderLeft: `4px solid ${theme.orange}`, boxShadow: '0 4px 20px rgba(15,23,42,.06)', marginBottom: 16, overflow: 'hidden' }}>
          {/* Header */}
          <div style={{ padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 14, borderBottom: `1px solid ${theme.border}` }}>
            <div style={{
              width: 40,
              height: 40,
              borderRadius: 12,
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 14, fontWeight: 600, color: theme.text }}>Pending Items</span>
                <span style={{
                  padding: '2px 8px',
                  borderRadius: 999,
              ...
              <div style={{ fontSize: 12, color: theme.text3, marginTop: 2 }}>Files pending for more than 15 days</div>
            </div>
          </div>

          {/* Pending Items List */}
          <div style={{ maxHeight: 400, overflowY: 'auto' }}>
            {cfiles.filter((r) => calculateDaysElapsed(r.date) > 15).map((pending, idx) => {
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 4 }}>
                      <span style={{ fontSize: 13, fontWeight: 600, color: theme.text }}>{pending.file_no}</span>
                      <span style={{ fontSize: 12, color: theme.text3 }}>•</span>
                      <span style={{ fontSize: 12, color: theme.text2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {pending.name_of_apartment || '—'}
                      </span>
                    </div>
                    <div style={{ fontSize: 12, color: theme.text3, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                    ...
                    <i className="fas fa-chevron-right" style={{ fontSize: 11, color: theme.text3 }} />
                  </div>
                </div>
              );
            })}
      ...
      <div style={{ background: theme.card, borderRadius: 12, border: `1px solid ${theme.border}`, boxShadow: '0 2px 12px rgba(0,0,0,.07)', overflow: 'hidden' }}>
        ...
        <div style={{ padding: '16px 18px', borderBottom: `1px solid ${theme.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
          <span style={{ fontSize: 14, fontWeight: 600, color: theme.text }}>C-File Records</span>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
